...
<body>
                    ...
                    <?php foreach ($models as $model):?>
                        <div class="cat item1">
                            ...
                            <div class="cat_detail">
                                <?php foreach ($model->children as $children):?>
                                    <dl class="dl_1st">
	...
	<div class="bottomnav w1210 bc mt10">
		<div class="bnav1">
			...
			<ul>
				<li><a href="https://help.jd.com/user/issue/list-29.htmlv">购物流程</a></li>
				<li><a href="">会员介绍</a></li>
...
<script>
    $.getJSON('http://frontend.yii2shop.com/member/checks',function(data){
                if(data.isGust==false){
                    var txt='欢迎'+data.identity.username+'用户来到西京商城'+'[<a href="member/logout" style="color: red">'+'注销'+'</a>]';
                    $('.login').html(txt);
                }
