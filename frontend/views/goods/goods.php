		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						   <a href="http://backend.yii2shop.com<?=$model->logo?>" class="jqzoom" style="height: 352px;width: 352px;" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://backend.yii2shop.com<?=$model->logo?>" style="height: 352px;width: 352px;" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li>
									...
									rel="{gallery: 'gal1', smallimage: 'http://backend.yii2shop.com<?=$gallery->path?>',largeimage: 'http://backend.yii2shop.com<?=$gallery->path?>
									'}">
	    							<img src="http://backend.yii2shop.com<?=$gallery->path?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?=\yii\helpers\Url::to(['cart/add-to-cart'])?>" method="get" class="choose">
						<ul>
