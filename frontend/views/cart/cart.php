...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr data-id="<?=$model['id']?>">
            ...
            <td class="col5">￥<span><?=number_format($model['shop_price']*$carts[$model['id']],2,'.','')?></span></td>
            <td class="col6"><input type="button" value="删除" class="del"/></td>
        </tr>
       <?php endforeach;?>
        </tbody>
        <tfoot>
    ...
    <div class="cart_btn w990 bc mt10">
        <a href="/goods/goods-category" class="continue">继续购物</a>
