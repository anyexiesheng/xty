...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="/goods/goods-category"><img src="/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
			...
			<div class="order_bd mt10">
				<table class="orders">
                    ...
                    <?php foreach ($models as $model):?>
						<tr>
							<td><a href=""><?=date('Ymd',$model->order->create_time) . sprintf("%06d", ($model->id));?></a></td>
							<td><a href=""><img src="http://backend.yii2shop.com<?=$model->logo?>" alt="" /></a></td>
							<td><?=$model->order->name?></td>
							<td>￥<?=$model->total?> <?=$model->order->delivery_name?></td>
							<td><?=date('Y-m-d H:i:s',$model->order->create_time)?></td>
							<td><?=\frontend\models\Order::$status[$model->order->status]?></td>
